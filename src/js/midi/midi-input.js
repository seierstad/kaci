    ...
    constructor (store) {
        ...
        this.valuePairs = {
            "BANK_SELECT": {
                "coarse": null,
                "fine": null,
                "action": MIDI.BANK_SELECT
            },
            "MODULATION_WHEEL": {
                "coarse": null,
                "fine": null,
                "action": MIDI.MODULATION_WHEEL
            },
            "BREATH_CONTROLLER": {
                "coarse": null,
                "fine": null,
                "action": MIDI.BREATH_CONTROLLER
            },
            "FOOT_PEDAL": {
                "coarse": null,
                "fine": null,
                "action": MIDI.FOOT_PEDAL
            },
            "PORTAMENTO_TIME": {
                "coarse": null,
                "fine": null,
                "action": MIDI.PORTAMENTO_TIME
            },
            "DATA_ENTRY": {
                "coarse": null,
                "fine": null,
                "action": MIDI.DATA_ENTRY
            },
            "VOLUME": {
                "coarse": null,
                "fine": null,
            ...
            "PAN_POSITION": {
                "coarse": null,
                "fine": null,
                "action": MIDI.PAN_POSITION
            },
            "EXPRESSION": {
                "coarse": null,
                "fine": null,
                "action": MIDI.EXPRESSION
            },
            "EFFECT_CONTROL_1": {
                "coarse": null,
                "fine": null,
                "action": MIDI.EFFECT_CONTROL_1
            },
            "EFFECT_CONTROL_2": {
                "coarse": null,
                "fine": null,
                "action": MIDI.EFFECT_CONTROL_2
            }
        };
    ...
    accessStateChangeHandler (event) {
        ...
        if (is) {
            if (connection !== is.connection) {
                this.store.dispatch({type: MIDI.PORT_CONNECTION_CHANGE, value});
                is.connection = connection;
            }
            if (state !== is.state) {
                this.store.dispatch({type: MIDI.PORT_STATE_CHANGE, value});
                is.state = state;
            }
        } else {
            if (port.type === "input") {
