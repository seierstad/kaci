import {wrappers} from "./waveforms";
import {mixValues, vectorToLinearFunction, getDistortedPhase} from "./sharedFunctions";
import DCGenerator from "./DCGenerator";
import IdealOscillator from "./IdealOscillator";
import {BUFFER_LENGTH} from "constants";

const PDOscillator = function (context, patch, frequency, options) {
    const inputDefs = [{
        name: "frequency",
    ...
    for (let i = 0, j = inputDefs.length; i < j; i += 1) {
